...
class StockPicking(models.Model):
    ...
    move_lines = fields.One2many('stock.move', 'picking_id', 'Internal Moves', states={'done': [('readonly', False)], 'cancel': [('readonly', True)]}, copy=True)
    ...
    def _prepare_pack_ops(self, cr, uid, picking, quants, forced_qties, context=None):
        ...
        for quant, dest_location_id in quants_suggested_locations.items():
            key = (quant.product_id.id, quant.package_id.id, quant.lot_id.id, quant.owner_id.id, quant.location_id.id, dest_location_id, quant.id)
