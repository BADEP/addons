...
##############################################################################
#
#    doo, Open Source Management Solution
...
class payroll_slip_parser(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        super(payroll_slip_parser, self).__init__(cr, uid, name, context)
...
class wrapped_report_payroll_slip(osv.AbstractModel):
    _name = 'report.l10n_ma_payroll.payslip_report_view'
    _inherit = 'report.abstract_report'
    _template = 'l10n_ma_payroll.payslip_report_view'
    _wrapped_report_class = payroll_slip_parser
