odoo.define('sale_product_configurator_uom_dimension.ProductConfiguratorFormView', function(require) {
    "use strict";
    var ProductConfiguratorFormController = require('sale_product_configurator_uom_dimension.ProductConfiguratorFormController');
