odoo.define('sale_uom_dimension.section_and_note_backend', function (require) {
    ...
    _productsToRecords: function (products) {
        ...
        _.each(products, function (product){
            var record = {
                ...
                default_product_dimension_qty: product.quantity,
            };
            ...
            if (product.dimension_values) {
                var default_dimension_values = [];
                _.each(product.dimension_values, function (dimension_value) {
                    default_dimension_values.push(
                            (0, 0, {
                                dimension_id: dimension_value.dimension_id,
                                quantity: dimension_value.quantity
                            })
                        );
                });
                record['default_dimension_ids']
