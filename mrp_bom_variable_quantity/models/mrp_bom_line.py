    ...
    def explode(self, product, quantity, picking_type=False):
        ...
        while bom_lines:
            ...
            if current_line.qty_type == 'fixed':
                ...
                if self.env.context.get('active_model') == 'mrp.production' and self.env.context.get('active_id'):
                    production_id = self.env['mrp.production'].browse(self.env.context['active_id'])
                eval_context = {
                    'env': self.env,
